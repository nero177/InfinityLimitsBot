...
async def command_start(message: Message, state: FSMContext) -> None:
    ...
    msg = await message.answer("🔒 Ми гарантуємо конфіденційність твоїх даних. Після введення, ти отримаєш посилання на твій перший урок, який допоможе тобі розпочати свій шлях до фінансового успіху.", reply_markup=keyboard)
    time.sleep(5)
